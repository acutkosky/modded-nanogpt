...
def optimistic_linear(x, W, alpha_x=1.0, alpha_w=0.0):
...
inner_hidden_optim = Muon(
    hidden_matrix_params, lr=0.03, momentum=0.95, update_smoothing=0.2, weight_decay=0.0, rank=rank, world_size=world_size
)

...
class Muon(torch.optim.Optimizer):
    ...
    """
    def __init__(self, params, lr=0.02, weight_decay=0.01, momentum=0.95, update_smoothing=0.1, rank=0, world_size=1):
        self.rank = rank
...
optimizer2 = Muon(hidden_matrix_params, lr=0.025, momentum=0.95, update_smoothing=0.1, rank=rank, world_size=world_size)
...
for step in range(train_steps + 1):
    ...
    for group in optimizer2.param_groups:
        ...
        group["momentum"] = (1 - frac) * 0.85 + frac * 0.85
